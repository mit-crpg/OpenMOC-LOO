...
Options::Options(int argc, const char **argv) {
	...
	_geometry_file = _relative_path + "xml-sample/PinCell/geometry.xml"; 	 /* Default geometry input file */
	_material_file = _relative_path + "xml-sample/PinCell/material.xml";    /* Default material input file */
